...
LastEditTime: 2024-03-30 13:28:36
FilePath: /pox/pox/misc/lab/assignment1/controller_assignment1.py
Description: 
...
rules=[
    ...
    {'EthSrc':h3_mac,'EthDst':h1_mac, 'queue':rule_cap50},
    {'EthSrc':h4_mac,'EthDst':h1_mac, 'queue':rule_capfree},
    
    #{'EthSrc':h2_mac,'EthDst':h1_mac, 'queue':rule_block},
    {'EthSrc':h3_mac,'EthDst':h2_mac, 'queue':rule_cap100},
    {'EthSrc':h4_mac,'EthDst':h2_mac, 'queue':rule_cap500},

    {'EthSrc':h1_mac,'EthDst':h3_mac, 'queue':rule_capfree},
    {'EthSrc':h2_mac,'EthDst':h3_mac, 'queue':rule_capfree},
    {'EthSrc':h4_mac,'EthDst':h3_mac, 'queue':rule_capfree},
    
    {'EthSrc':h1_mac,'EthDst':h4_mac, 'queue':rule_capfree},
    {'EthSrc':h2_mac,'EthDst':h4_mac, 'queue':rule_capfree},
